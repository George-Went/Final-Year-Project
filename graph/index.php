        ...
        <form id="form">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control" id="data_date" name="data_date" value="<?php echo $today; ?>" />
                </div>

                <div class="form-group col-md-4">
                    <label for="start">Start Time:</label>
                    <input type="time" class="form-control" id="start_time" name="start_time" value="<?php echo $today; ?>" />
                </div>
                ...
                function(data, status) {
                    ...
                    if (chart3_AIRMAR_TABLE) {
                        ...
                        let final_data_chart3_AIRMAR_values = {
                            ...
                            pitch: chart3_AIRMAR_TABLE_pitch,
                            title: 'AIRMAR'
                        }
                    ...
                    if (chart6_craft_TABLE) {
                        ...
                        let final_data_chart6_craft_values = {
                            ...
                            STBD_Rudder_Angle: chart6_STBD_Rudder_Angle,
                            title: 'Craft'
                        }
